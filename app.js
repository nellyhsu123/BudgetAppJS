...
var budgetController = (function() {
	...
	return {
		addItem: function(type, description, val) {
			...
			//grabs the id of the last item of the array to create new ID
		...
		deleteItem: function(type, id) {
			...
			//finds the index of where the wanted id is
...
var UIController = (function() {
	...
	var formatNumber = function(num, type) {
			...
			*/
			...
			num = Math.abs(num);
			num = num.toFixed(2); //places two decimal points at the end

			numSplit = num.split('.');

			int = numSplit[0];
			// add the comma using the substring method
			if(int.length > 3) {
	...
	return {
		...
		clearFields: function() {
			...
			fieldsArr = Array.prototype.slice.call(fields);//will convert to an array
		...
		displayDate: function() {
			...
			//var christmas = new Date(2016, 11, 25) 0 based
